...
<h1>Dairy Farm</h1>
 ...
 <form method="post" name="f1" action="action.php" onsubmit="return validate()" id="form-entry-data">
    ...
    <input type="text" id="customer_name" name="customer_name" autocomplete="off" class="form-control" >
...
<div class="form-group col-sm-4">
   ...
   <button type="submit" class="btn btn-info" name="dairyfrmsave" id="dairyfrmsave">Add New</button>
   <button type="submit" class="btn btn-info" name="update" id="update">Add</button>
